		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
                ...
                <form action="" method="post" role="form" class="contactForm">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="message" class="txt" rows="5" data-rule="required" data-msg="Please write something for us" placeholder="Message"></textarea>
                        <div class="validation"></div>
                    </div>
                    
                    <div class="text-center"><button type="submit" name="send" class="btn btn-theme btn-block btn-md">Send Message</button></div>
                </form>
				<?php
					if(isset($_POST['send'])){
						...
						$qry = "INSERT INTO message (message,email,subject,time,status,name)
							VALUES('$message','$email','$subject',NOW(),'Unread','$name')";
