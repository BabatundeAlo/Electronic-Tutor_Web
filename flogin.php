...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form method="post">
			<h2>Sign in <small>Faculty Login</small></h2>
			<hr class="colorgraph">

			<div class="form-group">
				<input type="text" name="user" placeholder="Enter Username" class="form-control input-lg"  tabindex="4">
			</div>
			<div class="form-group">
		...
		<?php
				if(isset($_POST['login'])){
					...
					$query = "SELECT * FROM faculty WHERE user = '$user' AND pass = '$pass'";
					$rs = $conn->query($query);
					$num = $rs->num_rows;
					$rows = $rs->fetch_assoc();
					if($num > 0){
