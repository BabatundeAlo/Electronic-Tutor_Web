	...
	<script type="text/javascript">
		function sureToApprove(id){
			if(confirm("Are you sure you want to delete this book?")){
				window.location.href ='delete_lawbook.php?id='+id;
			}
		}
	</script>
...
<body>
    ...
    <div id="wrapper">
      ...
      <div class="panel-heading">
        <h3 class="panel-title">Law Books</h3>
	...
	<button type="submit" class="btn btn-primary"  onclick="window.print()">Print Here</button>
    	<button type="submit" class="btn btn-primary" ><a href="law_upload.php" style="color:white;">Upload Book</a></button>
      </div>
    </div>
