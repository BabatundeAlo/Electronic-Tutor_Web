    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <button type="submit" class="btn btn-primary" ><a href="bus_view.php" style="color:white;">Go Back</a></button>
                        <br/>
                        <hr/>
					...
					<?php
							if(isset($_POST['send'])){
                               ...
                               if(move_uploaded_file($_FILES['book']['tmp_name'],$target_path1)){ }
								...
								$qr = "INSERT INTO business (image,book,book_name,book_cost,capacity,status) 
													VALUES ('$image','$book','$book_name','$book_cost','$capacity','Available')";
								$res = $conn->query($qr);
								if($res === TRUE){
									echo "<script type = \"text/javascript\">
											alert(\"Book Succesfully Added\");
											window.location = (\"bus_view.php\")
											</script>";
									}
								}
								else 'Failed';
