    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <button type="submit" class="btn btn-primary" ><a href="law_view.php" style="color:white;">Go Back</a></button>
                        <br/>
                        <hr/>
					...
					<?php
							if(isset($_POST['send'])){
                               ...
                               if(move_uploaded_file($_FILES['book']['tmp_name'],$target_path1)){ }
								...
								$qr = "INSERT INTO law (image,book,book_name,book_cost,capacity,status) 
