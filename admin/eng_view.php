	...
	<script type="text/javascript">
		function sureToApprove(id){
			if(confirm("Are you sure you want to delete this book?")){
				window.location.href ='delete_engbook.php?id='+id;
			}
		}
	</script>
...
<body>
    ...
    <div id="wrapper">
      ...
      <div class="panel-heading">
        <h3 class="panel-title">Engineering Books</h3>
    ...
    <table class="table">
        ...
        <tbody>
         <?php
								...
								$select = "SELECT * FROM engineering";
	...
	<button type="submit" class="btn btn-primary"  onclick="window.print()">Print Here</button>
    	<button type="submit" class="btn btn-primary" ><a href="eng_upload.php" style="color:white;">Upload Book</a></button>
      </div>
    </div>
