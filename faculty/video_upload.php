    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Videos can be Uploaded Here</h1>
                <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    
                        <button type="submit" class="btn btn-primary" ><a href="videos.php" style="color:white;">Go Back</a></button>
                        <br/>
                        <hr/>
					...
					<?php
							if(isset($_POST['send'])){
								...
								$qr = "INSERT INTO videos (video,title,extras) 
													VALUES ('$video','$title','1')";
								$res = $conn->query($qr);
								if($res === TRUE){
									echo "<script type = \"text/javascript\">
											alert(\"Video Succesfully Added\");
