...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form method="post">
			<h2>Sign in <small>Student Login</small></h2>
			<hr class="colorgraph">

			<div class="form-group">
				<input type="email" name="email" placeholder="Enter Email Address" class="form-control input-lg"  tabindex="4">
			</div>
			<div class="form-group">
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit"  name="log" value="Login" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
			</div>
		</form>
		<div id="fom">
		<?php
				if(isset($_POST['log'])){
					...
					$qy = "SELECT * FROM student WHERE email = '$uname' AND id_no = '$pass'";
					$log = $conn->query($qy);
					$num = $log->num_rows;
					$row = $log->fetch_assoc();
					if($num > 0){
